...
#permet d exporter un script salome qui genere une vue volumique(a faire)
...
class CATALOGUE_POUTRE:
    ...
    class section_rond:
        def __init__(self,parent):
            ...
            self.parametres=('diaext:diametre exterrieur',
                             'diaint:diametre interrieur = 0 par defaut')
    ...
    def __section_generation_sec(self,sec,nom):
        ...
        if (Vex[14]>1e-5 or Vex[14]<-1e-5):
            ...
            if (Vex[2]>Vex[1]):
                print "Iz>Iy ce n est pas naturel on corrige en tournant la section"
                rot=True
                caratemp=[Vex[0],#AIRE
    ...
    def sauvegarde_pour_3d(self,fichier,MODELE,MAILLAGE,CHAM_MATER,CARA_ELEM):
        ...
        orientation=orientation_poutre_beta2.orientation_poutre_vyz(GROUP_MA=lgroupma,
