...
localdir="/home/fred/asteretude/kuwait/"
...
#type de treilli
groupedesmaillesdecales=("decaler","ldecaler")
groupedesmaillessuperposer=("superposer")
groupedesmaillespannes=("panneback")

#type de hauteur
#par defaut hdefaut est utilise
hdefaut=-2;
#si on utilise un plan pour definir une hauteur variable preciser ci dessous le groupe et le nom du fichier
...
#SalomeIOBeam.GeoWrite(geofile,newnode,newline,newgrl,newgrn)
SalomeIOBeam.STRWrite(strfile,newnode,newline,newgrl,newgrn)
SalomeIOBeam.SalomeMesh(newnode,newline,newgrl,newgrn)
#SalomeIOBeam.SalomeGeom(newnode,newline,newgrl,newgrn)
