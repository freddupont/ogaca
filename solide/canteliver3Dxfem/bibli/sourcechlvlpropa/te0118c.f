...
C     ON CHERCHE LE NOEUDS SOMMET LE PLUS PROCHE
 ...
 30           CONTINUE
           ENDIF
         ENDIF
C	 write(*,*)'te0118 nbnode',NNOS
C	 write(*,*)'te0118 NDIME',NDIME
C	 write(*,*)'te0118 DMIN',DMIN
         ZR(ILC) = DMIN
...
C         WRITE(*,*)'GRADIENT DE LS SUR LELEMENT',NORMGR
...
C           WRITE(*,*)'CALCUL DE KI AUX NOEUDS',K(INO)
C           WRITE(*,*)'CALCUL DE KI NX',NX
C           WRITE(*,*)'CALCUL DE KI NY',NY
...
C            WRITE(*,*)'CALCUL DPHI(INO)',DPHI(INO)
C            WRITE(*,*)'CALCUL DELPHI',DELPHI
...
C	    WRITE(*,*)'CALCUL ALPHA(INO)',ALPHA(INO)
